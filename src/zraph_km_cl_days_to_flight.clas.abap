CLASS zraph_km_cl_days_to_flight DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zraph_km_cl_days_to_flight IMPLEMENTATION.

  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA(today) = cl_abap_context_info=>get_system_date( ).
    DATA bookings TYPE STANDARD TABLE OF zraph_KM_c_bookingwdtp WITH DEFAULT KEY.
